...
func NewGraftServer(graftHomePath, listenAddress string, listenPort int, username, password string, matchingPaths []string) {
	...
	//		os.Exit(2)
	//	}
	//	go HandleConn(conn, config, locator.SourceFiles)
	//}
